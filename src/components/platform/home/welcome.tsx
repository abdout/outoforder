...
const Welcome = () => {
  return (
    <div className='pt-6'>
        ...
        <p className='w-4/5 pt-8'>تعاونوا على البر والتقوى - إيماناً بسحر العمل الجماعي، نسعى من خلال هذه المنصة إلى أتمتة أعمال الحركة  وامتلاك ادوات تنسيق وتعاون افضل. ساهم في خلق تجربة جديدة من الكفاءة والتنظيم.</p>
        <p className='pt-4'>
