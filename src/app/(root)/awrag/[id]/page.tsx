    ...
    <div>
      ...
      <div className='w-[50rem]'>
            ...
            <div className='flex flex-col   gap-2'>
                <p>إلى الشعب السوداني الأصيل في ربوع الوطن بمختلف فئاته وانتماءاته</p>
                <p>إلى الشباب السوداني خاصة المتطلع نحو الوحدة والنهضة والأمن والازدهار, وكريم القيم والأخلاق</p>
                <h3 className='pt-4'>مقدمة وتعريف:</h3>
                <p>هذا البيان  التأسيسي للحركة  الوطنية  للبناء  والتنمية،  التي  هي حركة اصلاح اجتماعي وسياسي شامل، تقيم رؤاها وتستقي قيمها من هدي الدين وكريم شيم السودانيين، وتوظف الشأن
